...
if not c.LOCAL_ACCOUNTS_DISABLED:
    ...
    AutomatedEmailFixture(
        ...
        f"lambda a: a.placeholder and a.registered_local > parse_date('{earliest_opening_date}') and a.paid == c.NEED_NOT_PAY",
    ...
    AutomatedEmailFixture(
        ...
        'placeholders/regular.txt',
        f"lambda a: a.placeholder and a.registered_local > parse_date('{earliest_opening_date}') and \
