...
Session.model_mixin = UberSession.model_mixin
Session.all_models = UberSession.all_models
Session.resolve_model = UberSession.resolve_model
Session.engine = engine
Session.BaseClass = SQLModel
Session.SessionMixin = UberSession.SessionMixin
Session.session_factory = SessionFactory

def cleanup_scoped_session():
    Session.remove()

cherrypy.tools.db_session_cleanup = cherrypy.Tool('on_end_request', cleanup_scoped_session, priority=95)
cherrypy.config.update({"tools.db_session_cleanup.on": True})
